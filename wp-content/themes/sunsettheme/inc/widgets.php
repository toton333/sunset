...
class Sunset_Profile_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		echo '<p><strong>No options for this Widget!</strong><br/>You can control the fields of this Widget from <a href="./admin.php?page=sunset_general_slug">This Page</a></p>';
	}
	...
	public function widget( $args, $instance ) {
		...
		<div class="text-center">
			<div class="image-container">
				<div id="profile-picture-preview" class="profile-picture" style="background-image: url(<?php print $profile_picture_url; ?>);"></div>
			</div>
			...
			<div class="icons-wrapper">
				...
				<?php endif; 
				if( !empty( $gplus_icon ) ): ?>
					<a href="https://plus.google.com/u/0/+<?php echo $gplus_icon; ?>" target="_blank"><span class="dashicons dashicons-googleplus"></span></a>
				<?php endif; 
				if( !empty( $facebook_icon ) ): ?>
					<a href="https://facebook.com/<?php echo $facebook_icon; ?>" target="_blank"><span class="dashicons dashicons-facebook-alt"></span></a>
				<?php endif; ?>
			</div>
		</div>
		<?php
